...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--backbone', type=str, default='resnest269',
                            help='backbone name (default: resnest269)')
        parser.add_argument('--dataset', type=str, default='arcs',
                            help='dataset name (default: arcs)')
        ...
        # checking point
        parser.add_argument('--resume', type=str, default=r'E:\Project\PyTorch-Encoding\runs\arcs\deeplab\resnest269\default\model_best.pth.tar',
                            help='put the path to resuming file if needed')
        parser.add_argument('--checkname', type=str, default='model_best.pth.tar',
...
class Trainer():
    def __init__(self, args):
        ...
        self.valloader = data.DataLoader(
            testset, batch_size=args.batch_size, drop_last=False, shuffle=False, **kwargs)
